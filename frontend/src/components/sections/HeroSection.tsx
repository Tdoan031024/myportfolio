  ...
  const socials = useMemo(
    () => [
      ...
      },
      {
        ...
        svg: <path d="M4 6h16a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2zm0 2 8 5 8-5" />,
      },
    ],
    [],
  );
      ...
      <div className="relative z-0 mx-auto flex max-w-7xl flex-col gap-12 lg:flex-row lg:items-center">
        <div className="min-w-0 flex-1 lg:flex-[1.18]">
          ...
          <motion.div
            ...
            className="mt-4 flex flex-wrap items-center gap-2 text-sm text-white/58"
          >
            {["React", "Next.js", "NestJS", "Database", "AI"].map((skill) => (
              <span
                key={skill}
                className="rounded-full border border-white/10 bg-white/[0.035] px-3 py-1 text-white/72 backdrop-blur-sm"
              >
                {skill}
              </span>
            ))}
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            ...
            {socials.map((social) => (
              <a
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full border border-white/12 bg-white/[0.035] text-white/72 backdrop-blur-sm transition hover:-translate-y-0.5 hover:border-cyan-200/45 hover:bg-cyan-200/10 hover:text-cyan-100"
              >
