...
export default function IntroModelSection() {
  return (
    <section
      id="intro-3d"
      className="relative z-50 flex min-h-screen items-center justify-center overflow-visible pb-0"
    >
      <div className="relative z-50 flex w-full flex-col items-center overflow-visible">
        <div className="relative z-50 h-[160vh] w-full overflow-visible rounded-none bg-transparent -mb-78">
          <HeroThree
